...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    ...
    >
      {behindGlowEnabled && (
        <div
          className="absolute inset-0 z-10 pointer-events-none transition-opacity duration-200 ease-out"
          style={{
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <Image
                className="w-full absolute left-1/2 -bottom-1 will-change-transform transition-transform duration-[120ms] ease-out object-cover"
                width={1100}
                height={1100}
                src={avatarUrl}
              ...
              {showUserInfo && (
                <div
                  ...
                  className="absolute z-2 flex items-center justify-between border border-white/10 pointer-events-auto bg-primary"
                  style={
                    {
                      '--ui-inset': '20px',
                      '--ui-radius-bias': '6px',
                ...
                >
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex flex-col items-start gap-1">
                      <div className="text-sm font-medium text-primary-foreground leading-none">@{handle}</div>
                      <div className="text-[13px] italic text-primary-foreground leading-none">
                        &quot;{status}&quot;
                      </div>
                    </div>
                  </div>
                  <Button
                    variant="outline"
                    className='text-primary-foreground hover:text-primary-foreground w-[30%]'
            ...
            {/* Details content */}
            <div
              className="max-h-full overflow-hidden text-center relative z-[5] rounded-lg"
              style={{
                transform:
