        ...
        <div className='flex flex-row items-center justify-center md:justify-end gap-4 mt-4 w-full'>
          ...
          <div className='flex items-center gap-4 md:flex-row flex-col'>
            ...
            <Link href="https://www.b4i.unibocconi.it/">
              <Image src="/b4i-logo.webp" width={200} height={100} alt="b4i" className='object-contain' />
            </Link>
          </div>
        </div>
        <Separator className='my-6 bg-white' />
        <p className='text-white text-center mt-2 font-bold'><span className='font-normal'>©</span> {new Date().getFullYear()} Parkito - All rights reserved</p>
